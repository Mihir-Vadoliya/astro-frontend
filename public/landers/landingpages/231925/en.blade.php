@php($asset_path = '/landers/landingpages/231925/')
...
<body class="main_bg">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-3 text-end">
                        <a href="https://abstract-astro.com"><img src="{{$asset_path}}assets/images/astrology-offer-logo.png" class="img-fluid mb-3" width="50" height="50"></a>
                    </div>
                    <div class="col-6">
                        <h1 class="times fw-bold font-100 text-center text-white mb-0 pb-0">Free Personal Horoscope 2023</h1>
                        <p class="text-white font-16 times pt-3 text-center fw-bold">What do you wish most for 2023? Money, Luck or Love </p>
                    </div>
                    <div class="col-3">
                        <img src="{{$asset_path}}assets/images/padre-img.png" class="d-none img-fluid mb-3 rounded-circle" width="50" height="50">
                    </div>
                </div>
            </div>
        </header>
        ...
        <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 col-xxl-7">
                            <div class="box-content">
                                <h1 class="times fw-bold font-24 text-center text-white mb-0 pt-2 pb-2">Choose your zodiac sign</h1>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6 text-center">
                                    <label class="choose_gender_btn">
                                        ...
                                        <span class=" position-relative z-index-1 montserrat text-white  medium font24">Woman</span><br>
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    ...
                                    <button type="submit" class="email_continue_btn font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border"><i class="fa fa-hand-o-right px-2"></i><b>GET YOUR FREE READING</b></button>
                                    <style>
                                        .special-gift{
                                            color: #fff;
                                            padding-top: 20px;
            ...
            <div class="gtm-screen-pending step__10 text-center" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <div class="row justify-content-center mx-0 w-100">
                        <div class="col-12 col-md-6 col-xxl-7 text-white">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.email_continue_btn').on('click', function() {
