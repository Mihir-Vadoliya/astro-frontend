@php($asset_path = '/landers/landingpages/600012/')
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="times fw-normal text-white">
                        CLAUSE DE NON-RESPONSABILITÉ : LES INFORMATIONS FOURNIES NE DOIVENT PAS ÊTRE CONSIDÉRÉES COMME DES
                        CONSEILS DANS LE DOMAINE DE LA PSYCHOLOGIE, DE LA MÉDECINE, DE L'ÉCONOMIE-FINANCE, DE L'IMMOBILIER,
                        DES QUESTIONS JURIDIQUES OU AUTRES ET NE DOIVENT EN AUCUN CAS ÊTRE UTILISÉES COMME BASE DE DÉCISION,
                        MAIS UNIQUEMENT POUR DES RAISONS DE DIVERTISSEMENT, QU'ELLES SOIENT GRATUITES OU PAYANTES.<br><br>
                        LES TÉMOIGNAGES, CRITIQUES ET AVALS SONT DES OPINIONS INDIVIDUELLES LIBRES QUI N'IMPLIQUENT PAS DES
                        RÉSULTATS SIMILAIRES POUR TOUT LE MONDE. VEUILLEZ LIRE LES TERMES ET CONDITIONS.<br><br>
                        @include('/landers/terms/dynamic/dynamic') {{ print_dynamic_variable('address') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content rounded-0 border-0">
                ...
                <div class="modal-body">
                    ...
                    <p class="arial fw-light mb-4 text-black font-16 line-height-24 pt-3">
                        ...
                        1) Envoyez votre message à <a href="mailto:dpo@astrology-lotus.com">dpo@astrology-lotus.com</a> <br><br>
