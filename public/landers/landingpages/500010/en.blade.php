@php($asset_path = '/landers/landingpages/500010/')
@php($srcImg = "/landers/sets/set47/")
...
<head>
    ...
    <meta property="og:image" content="{{$srcImg}}/astro-logo-seo.png" />
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-8 my-auto order-2 order-md-1">
                    <div class="text-center pt-3 pt-md-0">
                        <p class="fw-bold mb-0 text-white font-38">Don't miss your chance to win a prize!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row mx-0 w-100">
                ...
                <div class="col-12 col-md-12 col-lg-2 my-auto col-xl-2 col-xxl-2 position-relative pt-3 sign-icon-div d-none">
                    <div class="banner_right_content mt-5 mt-md-5 pt-md-3 ps-xl-5 ms-xxl-5">
                        <div class="right_cnt_onebox">
                            <img src="/landers/sets/set47/taurus.png" class="img-fluid select-sign">
                        </div>
                ...
                <form name="g" id="nameForm" class="main_form col-12 col-md-12 pt-3 col-lg-12 col-xl-12 col-xxl-12 position-relative sign_show" method="post" action="{{request()->url()}}/insertlead">
                    ...
                    <!-- step 1 signs -->
                    <div class="all_steps pt-4 row d-block d-md-block ">
                    ...
                    <div class="center_div center_content">
                        ...
                        <!-- step 2 -->
                        <div class="step_2 d-none gtm-screen-birthdate">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 pt-20 text-center">
                                    <p class="error step_2_error d-none">Please indicate the full date</p>
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="bck_btn   font-18 text-decoration-none text-center d-inline-block text-white step_2_prev">Back</a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="continue_btn font-18 text-decoration-none text-center d-inline-block text-white step_2_next">Continue</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- step 3 -->
                        <div class="step_3 d-none gtm-screen-city">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 pt-20 text-center">
                                    <p class="error step_3_error d-none">Please enter your city</p>
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                        ...
                        <!-- step 4 -->
                        <div class="step_4 d-none gtm-screen-email">
                            <h3 class="fw-bold font-28 text-uppercase text-white text-center heading_steps">Lucky that you are eligible
                                <br><br>
                                Please submit your e-mail address and wait to be redirected to your quiz
                            </h3>
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-10 col-lg-7 col-xl-11 col-xxl-12">
                                    ...
                                    <div class="col-12 pt-20 text-center">
                                        <p class="error email_error_2 d-none">Please fill out this fields </p>
                                        <ul class="list-unstyled list-inline">
                                            <li class="list-inline-item me-0 w-100">

                                                <button type="button" class="continue_btn font-18  text-decoration-none text-center d-inline-block w-100 continue_btn-border px-lg-2 px-xxl-3  text-white btn_1 bev button-email email_btn"><i class="fa fa-hand-o-right px-2"></i>
                                                    <b>Redirecting</b>
                                                </button>
                                            </li>
                                        </ul>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 my-auto  px-3 px-md-0">
                    <div class="disclaimer_cnt mt-5 mt-md-0 ps-xl-5 ms-xxl-5 ">
                        <div class="right_cnt_onebox ">
                            <h3 class="text-white font-18 fw-bold mb-4 text-uppercase text-center">DISCLAIMER</h3>
