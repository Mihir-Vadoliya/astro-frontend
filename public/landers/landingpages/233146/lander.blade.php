            ...
            <div class="row">
                <div class="mid-main-box">
                    <div class="step-lidiya">
                        <img src="{{ $asset_path }}assets/images/Christin.jpg" alt="maria-woman" class="maria" style="border-radius: 50%;" >
                    ...
                    <p class="personal-date">
                        ...
                        Astrofysica, Willem de Zwijgerlaan 150, 1056JV, Amsterdam.
                    </p>
                </div>
            </div>
        </form>
