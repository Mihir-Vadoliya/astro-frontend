@php($asset_path = '/landers/landingpages/271912/')
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-8 my-auto order-2 order-md-1">
                    <div class="text-center pt-3 pt-md-0">
                        <p class="fw-bold mb-0 text-white font-38">Get Your Personal 2023 HOROSCOPE</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="footer_link pt-3 pt-xxl-5">
                        <ul class="footer_menus list-unstyled mb-0 d-flex justify-content-center">
                            ...
                            <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-black fw-bold text-decoration-none font-16 text-uppercase cookie_btn_open">Cookie
                                    policy</a></li>
                            <li class="list-inline-item4 me-0 "><a href="javascript:void(0);" class="text-black fw-bold text-decoration-none font-16 text-uppercase terms_btn_open">Terms
                                    of
                                    service</a></li>
                        </ul>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="opensans fw-normal font16">
                        ...
                        <a href="https://astro.all-universe.com" class="text-decoration-none">https://astro.all-universe.com</a> (“Website” or “Service”) and any of its related products and
                        services
