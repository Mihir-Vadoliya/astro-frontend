@php($asset_path = '/landers/landingpages/285943/')
@php($srcImg = "/landers/sets/set48/")
...
<body class="main_bg">
    ...
    <div class="modal fade" id="social_model" aria-labelledby="exampleModalToggleLabel" tabindex="-1" data-bs-backdrop="static" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-1 rounded-5">
                <div class="modal-body">
                    <button type="button" class="close close-btn" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <div class="modal-header">
                        <p class="modal-title font-20 fw-normal mb-0 text-center fw-bold">Suivez sur les réseaux sociaux
                            pour plus de contenu sur l'astrologie et la spiritualité</p>
                    </div>
                    <div class="d-flex justify-content-center pt-3 px-3">
                        <a href="javascript:void(0);" class="text-decoration-none">
                            <img src="/landers/landingpages/251275/assets/images/instagram.png" class="social_icon social_icon_link" data-id="instagram">
                        </a>
                        <a href="javascript:void(0);" class="text-decoration-none">
                            <img src="/landers/landingpages/251275/assets/images/facebook.png" class="social_icon social_icon_link" data-id="facebook">
                        </a>
                        <a href="javascript:void(0);" class="text-decoration-none">
                            <img src="/landers/landingpages/251275/assets/images/youtube.png" class="social_icon social_icon_link" data-id="youtube">
                            <!-- <i class="fa-brands fa-youtube text-dark font-65 px-3"></i> -->
                        </a>
                        <a href="javascript:void(0);" class="text-decoration-none">
                            <img src="/landers/landingpages/251275/assets/images/tictock.png" class="social_icon social_icon_link" data-id="tictock">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.social_icon_link').on('click', function() {
                ...
                var instagram_url = 'https://www.instagram.com/athena.clairvoyante';
                var facebook_url = 'https://www.facebook.com/athena.clairvoyante';
                var youtube_url = 'https://www.youtube.com/@athenaclairvoyante';
                var tiktok_url = 'https://www.tiktok.com/@athena.clairvoyante';
                var linksArray = [];
