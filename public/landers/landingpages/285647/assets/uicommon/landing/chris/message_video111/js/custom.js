    ...
    $(".step_3_btn").on("click", function () {
        ...
        if ($('.day').val() == '' || $('.month').val() == '' || $('.year').val() == '') {
            $("#step_3_error").html('Indique los datos completos');
    ...
    $(".step_4_btn").on("click", function () {
        ...
        if (step_4 == '') {
            $("#step_4_error").html('Rellene este campo');
        } else {
    ...
    $(".step_8_btn").on("click", function () {
        ...
        if (fname == '' || lname == '') {
            $("#step_8_error").html('Rellene este campo');
        } else {
    ...
    $(".step_9_btn").on("click", function () {
        ...
        if (email == '') {
            $("#step_9_error").html('Rellene este campo');
        } else if (mail != true) {
            $("#step_9_error").html('Introduzca una dirección de correo electrónico válida');
        } else {
