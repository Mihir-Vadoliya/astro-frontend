@php($asset_path = '/landers/landingpages/500001/')
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ $asset_path }}assets/css/slick.css" />
    <link rel="stylesheet" type="text/css" href="{{ $asset_path }}assets/css/slick-theme.css" />
...
<body class="main_bg">
    ...
    <div class="astrology-offerpage-main  position-relative">
        ...
        <div class="d-md-flex d-lg-flex">
            <div class="col-12 col-lg-4 col-md-4">
                <a class="d-flex justify-content-center" href="https://abstract-astro.com"><img src="{{$asset_path}}assets/images/astrology-offer-logo.png" class="img-fluid mb-3"></a>
            </div>
            <div class="col-12 col-lg-8 col-md-8">
                <h3 class="times font-100 text-center text-md-start text-lg-start text-white px-right fw-bold pt-30 pb-3"><span class="">Free Personal Horoscope 2023</span></h3>
            </div>
        </div>
        ...
        <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
            ...
            <section class="gtm-screen-zodiac astrology-offerpage-step-1 step_1_content common_cls_display1 step_1" id="step_1">
                <div class="container">
                    <div class="box-content">
                        <p class="text-white font-16 times text-center fw-bold">What do you wish most for 2023? Money,
                            Luck
                            or Love </p>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 col-xxl-7">
                            <div class="d-flex flex-wrap justify-content-center justify-md-content-between">
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="aries">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/3
                                            - 20/4</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="taurus">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/4
                                            - 20/5</span>
                                ...
                                <div class="mb-3 me-0 me-lg-0 me-xl-3">
                                    <label class="radio_cus_button" data-sign="gemini">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/5
                                            - 20/6</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-0">
                                    <label class="radio_cus_button" data-sign="cancer">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/6
                                            - 22/7</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="leo">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">23/7
                                            - 22/8</span>
                                ...
                                <div class="mb-3 me-0 me-lg-0 me-xl-3">
                                    <label class="radio_cus_button" data-sign="virgo">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">
                                            23/8 - 21/9</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="libra">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">22/9
                                            - 20/10</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-0">
                                    <label class="radio_cus_button" data-sign="scorpio">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/10
                                            - 20/11</span>
                                ...
                                <div class="mb-3 me-0 me-lg-0 me-xl-3">
                                    <label class="radio_cus_button" data-sign="sagittarius">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">21/11
                                            - 21/12</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="capricorn">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">22/12
                                            - 21/1</span>
                                ...
                                <div class="mb-3 me-3 me-lg-3 me-xl-3">
                                    <label class="radio_cus_button" data-sign="aquarius">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">22/1
                                            - 18/2</span>
                                ...
                                <div class="mb-3 me-0 me-lg-0 me-xl-0">
                                    <label class="radio_cus_button" data-sign="pisces">
                                        ...
                                        <span class="text-center text-white times fw-bold font-20 position-relative z-index-1">19/2
                                            - 20/3</span>
                        ...
                        <div class="col-12 col-md-6 col-xxl-5">
                            <div class="row">
                                ...
                                <div class="col-12 text-center pt-4">
                                    <button type="button" class="all_continue_btn font-20 text-center text-white d-inline-block continue_btn-border" onclick="back(1,2);">
                                        <b>
                                            < Back</b>
                                    </button>
                                </div>
            ...
            <section class="gtm-screen-birthdate select_born_date" id="step_3" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">What is your date of birth?
                    </h3>
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6 col-xxl-5">
                            <div class="row">
                                ...
                                <div class="col-12 ">
                                    <div class="text-center">
                                        <p class="text-white font-16 times pt-3">This will help you to make your fortune
                                            telling more accurate.</p>
                                    </div>
                                </div>
                                <div class="col-12 text-center">
                                    <button type="button" class="all_continue_btn font-20 text-center text-white d-inline-block continue_btn-border"><b>CONTINUE</b>
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <section class="gtm-screen-city select_city" id="step_4" style="display:none;">
                <div class="conatiner">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">In which city were you born?
                    </h3>
            ...
            <section class="gtm-screen-birthtimeknown you_know_born_time" id="step_5" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">Do you know what time you were
                        born?</h3>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 ">
                            <div class="text-center">
                                <p class="text-white font-16 times pt-3">This will help you to make your fortune telling
                                    more accurate.</p>
                            </div>
                        </div>
                    </div>
            ...
            <section class="gtm-screen-birthtime select_hour_minutes" id="step_6" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">Please enter the hours and
                        minutes
                        as accurately as possible</h3>
                    <div class="row justify-content-center">
            ...
            <!-- new steps 8 -->
            <section class="gtm-screen-nam enter_name_det" id="step_8" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
            ...
            <section class="gtm-screen-email enter_email_field" id="step_9" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">Where do you want to receive
                        your
                        Free Reading and Gifts?</h3>
                    <div class="row justify-content-center mx-0 w-100">
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="submit" class="all_continue_btn step_10_next font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border">
                                        <i class="fa fa-hand-o-right px-2"></i><b>GET YOUR FREE READING</b></button>
                                    <style>
                                        .special-gift{
                                            color: #fff;
                                            padding-top: 20px;
            ...
            <div class="gtm-screen-pending step__10 text-center" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <div class="row justify-content-center mx-0 w-100">
                        <div class="col-12 col-md-6 col-xxl-7">
    ...
    <section class="gtm-screen-thankyou step_10 last_step_content" id="step_11" style="display:none;">
        @include('/landers/landingpages/thankyou/'.$language.'/thankyou')
    </section>

    </form>

    <div class="mid-main-box times">
        <p class="personal-date text-white">
            ...
            <div id="footer">
                <ul class="footer_menu text-center list-inline list-unstyled">
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1  pe-xxl-1">
                        <a href="javascript:void(0);" class="text-white text-uppercase text-decoration-none tos_modal_open times font-20">Terms
                            and conditions</a>
                    </li>
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1  pe-xxl-1">
                        <a href="javascript:void(0);" class="text-white text-uppercase text-decoration-none privacy_pp_open times font-20">PRIVACY
                            POLICY</a>
                    </li>
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
                    ...
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
                        <a href="javascript:void(0);" class="text-decoration-none text-uppercase help_pp_open text-white times font-20">ETHICS
                            RULES</a>
                    </li>
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
    ...
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="contact_us1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">Terms and
                    conditions</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <p class="arial fw-light mb-0 text-black font-16 line-height-24 pt-0">
    ...
    <div class="astrology-offerpage-hlp-pop modal fade contact_us_popup privacy-1" id="privacy_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                ...
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <p class="arial fw-light m-0 p-0  text-black font-16 line-height-24">
    ...
    <div class="astrology-offerpage-tc-popup modal fade contact_us_popup" id="terms_pp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                ...
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <p class="arial fw-light mb-0 p-0 text-black font-16 line-height-24">
    ...
    <div class="astrology-offerpage-tc-popup modal fade contact_us_popup" id="cookie_policy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">
                    Cookies Policy</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.step_10_next').on('click', function() {
