...
@extends('landers.layouts.default')

@section('meta-text', 'Astrofysica')
@section('meta-icon', $asset_path . 'logo.png')
@section('shortcut-icon', $asset_path . 'favicon.png')
...
@section('body')
    ...
    @if($gtmContainerId)
        @indclude('google.noscipt-gtmcontainer')
    @endif
    ...
    @include('landers.layouts.terms-modal')
