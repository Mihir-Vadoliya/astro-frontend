...
/*********************** Step 1 ***********************/
$("#step_1 .choose_sign_1").on("click", function () {
    let sign = $(this).data("sign");
    //for selected sign
    if ($(window).width() >= 991) {
        $(".choose_sign_1").find("img").removeClass("sign_checked");
        $(this).children("img").addClass("sign_checked");
    } else {
        $(".choose_sign_1").find("img").removeClass("border-sm");
        $(this).children("img").addClass("border-sm");
    }
...
$(document).ready(function () {
    $(".terms_modal_open").click(function () {
        $("#terms_modal").modal("show");
    });
    $(".privacy_modal_open").click(function () {
        $("#privacy_modal").modal("show");
    });
    $(".gdpr_modal_open").click(function () {
        $("#gdpr_modal").modal("show");
    });
    $(".faq_modal_open").click(function () {
