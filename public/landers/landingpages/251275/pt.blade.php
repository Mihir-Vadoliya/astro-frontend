@php($asset_path = '/landers/landingpages/251275/')
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-3 col-md-3 col-lg-3">
            <div class="head_person_image border-0 text-center text-md-center">
              <a href="https://moon-pion.com/index.php?lang=PT">
                <img src="{{$asset_path}}assets/images/logo.png">
              </a>
            </div>
          </div>
          <div class="col-9 col-md-9 col-lg-9 mt-lg-5 mt-md-5">
            <p class="font-18 text-white montserrat fw-regular text-center text-md-start text-lg-start">Dinheiro... Sorte... Felicidade...</p>
            <h2 class="font-40 montserrat fw-bold text-white text-center text-md-start text-lg-start md-5">O que 2023 reserva para voce?</h2>
          </div>
        ...
        <div class="row justify-content-center mx-0 w-100">
          <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
            ...
            <div class="col-12 col-sm-12 col-md-10 step_1_title">
              <p class="montserrat font-24 text-white fw-regular text-center text-md-start mt-3 mt-xxl-5">SELECCIONE O SEU SIGNO DO ZODÍACO</p>
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-10  step_2_title d-none">
              <p class="montserrat font-24 text-white fw-regular text-center text-md-start mt-3 mt-xxl-5">Bem! Quando nasceu?</p>
            </div>
            <div class="gtm-screen-birthdate col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_2 d-none">
              <div class="row">
                ...
                <div class="col-12 text-center text-md-start mt-5">
                  <button type="button" class="continue_btn font-16 text-white text-uppercase montserrat step_2_next">Continuar</button>
                </div>
                <div class="col-6 pt-5 mt-3">
                  <p class="font-20 montserrat text-white fw-bold text-uppercase"><i class="fa-solid fa-arrow-left" onclick="back_step('.step_1','.step_2');"></i>
                  </p>
                </div>
                <div class="col-6 pt-5 mt-3">
            ...
            <div class="col-12 col-sm-12 col-md-10 step_3_title d-none">
              ...
              <p class="montserrat font-24 fw-regular text-white text-uppercase text-center text-md-start mt-5">Qual é o seu gênero?
              </p>
            </div>
            <div class="gtm-screen-gender col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_3 d-none">
              <div class="row justify-content-start">
                ...
                <div class="col-12 text-center text-md-start mt-5">
                  <button type="button" class="continue_btn font-16 text-white text-uppercase montserrat step_3_next">Continuar</button>
                </div>
                <div class="col-6 pt-5 mt-3">
            ...
            <div class="col-12 col-sm-12 col-md-10 step_4_title d-none">
              <p class="montserrat font-24 fw-regular text-white text-uppercase text-center text-md-start mt-5">Qual é o seu nome?
              </p>
            </div>
            <div class="gtm-screen-name col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_4 d-none">
              <div class="row justify-content-start">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                  <label class="montserrat font-20 text-white d-block fw-regular mb-2">Primeiro nome:</label>
                  <input type="text" placeholder="Primeiro nome" class="first_name_field" name="first_name">
                </div>
                <div class="col-12 col-md-12 col-lg-6 col-xl-6 mt-2 mt-md-0">
                ...
                <div class="col-12 text-center text-md-start mt-3">
                  <button type="button" class="continue_btn font-16 text-white text-uppercase montserrat step_4_next">Continuar</button>
                </div>
            ...
            <div class="col-12 col-sm-12 col-md-10 step_5_title d-none">
              <p class="montserrat font-24 fw-regular text-white text-uppercase text-center text-md-start mt-5">Em que cidade você nasceu?
              </p>
            </div>
            <div class="gtm-screen-city col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_5 d-none">
              <div class="row justify-content-start">
                ...
                <div class="col-12 text-center text-md-start mt-5">
                  <button type="button" class="continue_btn font-16 text-white text-uppercase montserrat step_5_next">Continuar</button>
                </div>
                <div class="col-6 pt-5 mt-3">
            ...
            <div class="col-12 col-sm-12 col-md-10 step_6_title gtm-screen-email d-none">
              <p class="montserrat font-24 fw-regular text-white text-uppercase text-center text-md-start mt-2">Onde quer obter a sua clarividência personalizada?</p>
            </div>
            <div class="gtm-screen-email col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_6 d-none">
              <div class="row justify-content-start">
                ...
                <div class="col-12 text-center text-md-start mt-3">
                  ...
                  <button type="submit" class="gtm-email-continue continue_btn font-16 text-white text-uppercase montserrat step_6_next" id="get_clarification">Obtenha meu horóscopo pessoal gratuito para 2022</button>
                </div>
                <div class="col-6 mt-3">
                  <p class="font-20 montserrat text-white fw-bold text-uppercase"><i class="fa-solid fa-arrow-left" onclick="back_step('.step_5','.step_6');"></i>
                  </p>
                </div>
                <div class="col-6 mt-3">
            ...
            <div class="gtm-screen-thankyou col-12 col-sm-12 col-md-10 gtm-screen-thankyou text-center d-none">
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6">
                    <div class="testimonial_content text-center text-md-start">
                      ...
                      <p class="text-646464 font-20 montserrat mt-4">Eu conhecia esses princípios, mas não coloquei colocá-los em prática porque eu não sabia onde...</p>
                  ...
                  <div class="col-12 col-sm-12 col-md-6">
                    <div class="testimonial_content text-center text-md-start">
                      ...
                      <p class="text-646464 font-18 montserrat mt-4">Eu tenho ouvido a faixa todas as noites antes indo para a cama nos últimos 10 dias. Meus pesadelos têm...</p>
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6">
                    <div class="testimonial_content text-center text-md-start">
                      ...
                      <p class="text-646464 font-18 montserrat mt-4">Muito bom guia. Bem detalhado. Fácil de colocar em pratique depois de tirar todas as suas dúvidas.</p>
                  ...
                  <div class="col-12 col-sm-12 col-md-6">
                    <div class="testimonial_content text-center text-md-start">
                      ...
                      <p class="text-646464 font-18 montserrat mt-4">Este guia realmente atendeu às minhas expectativas. Obrigado Ágata para oferecendo on-line.</p>
  ...
  <footer class="footer py-3">
    <div class="container">
      <ul class="text-center list-inline list-unstyled mb-0">
        <li class="list-inline-item me-3"><a href="javascript:void(0);" class="text-black montserrat fw-regular font-16 text-decoration-none privacy_modal">PRIVACIDADE POLÍTICA</a>
        </li>
        <li class="list-inline-item me-3"><a href="javascript:void(0);" class="text-black montserrat fw-regular font-16 text-decoration-none terms_modal">TERMOS E CONDIÇÕES DA ASTROVEO</a></li>
        <li class="list-inline-item me-3"><a href="javascript:void(0);" class="text-black montserrat fw-regular font-16 text-decoration-none gdpr_modal">GDPR</a></li>
        <li class="list-inline-item"><a href="https://moon-pion.com/contact.php?lang=PT" class="text-black montserrat fw-regular font-16 text-decoration-none contact_modal text-uppercase">Contato</a></li>
      </ul>
    </div>
  </footer>
  <!-- footer end -->
