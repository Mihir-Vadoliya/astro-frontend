@php($asset_path = '/landers/landingpages/261815/')
    ...
    <header class="header">
        <div class="container">
            <div class="text-center">
                <a href="https://lp.all-universe.com"><img src="{{$asset_path}}assets/images/astro-logo.png" class="img-fluid logo pt-2 pb-2"></a>
            </div>
        </div>
    </header>
    <section class="aleart_section">
        <div class="container">
            <div class="alert_top text-center">
                <h1 class="pb-12 lh-20"><span id="alertcopy " class="roboto fw-normal font-28 text-white text-uppercase"> Get Your Personal FREE 2023 HOROSCOPE </span>
                </h1>
            </div>
        </div>
    </section>
    <section class="main_banner">
        <div class="container">
            <div class="row mx-0 w-100">
                ...
                <form name="g" id="nameForm" class="main_form col-12 col-md-12 pt-3 col-lg-12 col-xl-12 col-xxl-12 position-relative sign_show" method="post" action="javascript:void(0);">
                    @csrf
                    ...
                    <div class="center_div center_content">
                        <div class="step_1 d-block step_1_sign">
                            <h3 class="text-center fw-bold font-28 text-uppercase text-white step_1_title">Choose your
                                zodiac sign</h3>
                        </div>
                        ...
                        <div class="step_3 d-none gtm-screen-birthdate">
                            <h3 class="fw-bold font-28 text-uppercase text-white text-center heading_steps">Well! When were
                                you born?
                            </h3>
                            <div class="row justify-content-center">
                        ...
                        <div class="step_9 d-none gtm-screen-email">
                            <h3 class="fw-bold font-28 text-uppercase text-white text-center heading_steps">Where do you
                                want to get your free horoscope?
                            </h3>
                            <div class="row justify-content-center">
                                    ...
                                    <div class="col-12 pt-20 text-center">
                                        ...
                                        <ul class="list-unstyled list-inline">
                                            <li class="list-inline-item me-0 w-100">
                                                <button type="button" class="continue_btn   font-18  text-decoration-none text-center d-inline-block w-100 continue_btn-border px-lg-2 px-xxl-3  text-white step_9_next">
                ...
                <div class="col-12 col-md-12 col-lg-12 my-auto  px-3 px-md-0">
                    <div class="footer_link pt-3 pt-xxl-5">
                        <ul class="footer_menus list-unstyled mb-0 d-flex justify-content-center">
                            <li class="list-inline-item  me-4 mb-3  "><a href="https://lp.all-universe.com" class="text-white fw-bold text-decoration-none font-16 text-uppercase">Home</a>
                            </li>
                            <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase privacy_btn_open">Privacy
                                    policy</a></li>
                            <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase rules_btn_open">Ethical
                                    rules</a></li>
                            <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase gdpr_btn_open">GDPR</a>
                            </li>
                            <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase cookie_btn_open">Cookie
                                    policy</a></li>
                            <li class="list-inline-item4 me-0 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase terms_btn_open">Terms
                                    of
                                    service</a></li>
                        </ul>
                    </div>
    ...
    <div class="modal fade" id="gdpr_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="opensans fw-normal font16">
                        Astroveo, {{ print_dynamic_variable('address') }}<br><br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="opensans fw-normal font16">
                        ...
                        <a href="https://astro.all-universe.com" class="text-decoration-none">https://astro.all-universe.com</a> (“Website” or “Service”) and any
                        of its related products and services
