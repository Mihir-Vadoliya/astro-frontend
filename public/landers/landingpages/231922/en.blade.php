@php($asset_path = '/landers/landingpages/231922/')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <a href="https://abstract-astro.com"><img src="{{$asset_path}}assets/images/astrology-offer-logo.png" class="img-fluid mb-3" width="100" height="100"></a>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="submit" class="all_continue_btn font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border"><i class="fa fa-hand-o-right px-2"></i><b>GET YOUR FREE READING</b></button>
                                    <style>
                                        .special-gift{
                                            color: #fff;
                                            padding-top: 20px;
