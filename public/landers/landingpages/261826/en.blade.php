@php($asset_path = '/landers/landingpages/261826/')
                    ...
                    <div class="d-flex justify-content-center">
                      <div class=" text-md-end">
                        <label class="choose_gender_btn">
                          ...
                          <span
                            class=" position-relative z-index-1 montserrat color-10212b fw-bold medium font24">Man</span><br>
                      ...
                      <div class="ms-5">
                        <label class="choose_gender_btn">
                          ...
                          <span
                            class=" position-relative z-index-1 montserrat color-10212b fw-bold medium font24">Woman</span><br>
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn montserrat medium font-18 text-decoration-none text-center d-inline-block text-white step_2_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn montserrat medium font-18 text-decoration-none text-center d-inline-block text-white step_2_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-12 pt-20 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn   font-18 text-decoration-none text-center d-inline-block text-white step_3_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn font-18 text-decoration-none text-center d-inline-block text-white step_3_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-12 pt-20 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn   font-18 text-decoration-none text-center d-inline-block text-white step_4_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn   font-18 text-decoration-none text-center d-inline-block text-white step_4_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                      ...
                      <ul class="list-inline list-unstyled mb-xxl-5">
                        <li class="list-inline-item">
                          <label class="choose_yesno_btn choose_yesno_btn_yes">
                            <span
                              class=" position-relative z-index-1 text-uppercase fw-bold color-10212b font-18">Yes</span><br>
                        ...
                        <li class="list-inline-item">
                          <label class="choose_yesno_btn choose_yesno_btn_no">
                            <span
                              class=" position-relative z-index-1 text-uppercase fw-bold color-10212b  font-18">NO</span><br>
                    ...
                    <div class="col-12 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn montserrat medium font-18 text-decoration-none text-center d-inline-block text-white step_5_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn montserrat medium font-18 text-decoration-none text-center d-inline-block text-white step_5_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-12 pt-20 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn font-18 text-decoration-none text-center d-inline-block text-white step_6_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn   font-18 text-decoration-none text-center d-inline-block text-white step_6_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center mx-0 w-100">
                    ...
                    <div class="col-12 pt-20 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn   font-18 text-decoration-none text-center d-inline-block text-white step_7_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn font-18 text-decoration-none text-center d-inline-block text-white step_7_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-12 pt-20 text-center">
                      ...
                      <ul class="list-unstyled list-inline">
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="bck_btn font-18 text-decoration-none text-center d-inline-block text-white step_8_prev">Back</a>
                        </li>
                        <li class="list-inline-item">
                          <a href="javascript:void(0);"
                            class="continue_btn font-18 text-decoration-none text-center d-inline-block text-white step_8_next">Continue</a>
                        </li>
                      </ul>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-12 col-md-12 col-lg-12 my-auto  px-3 px-md-0">
          <div class="disclaimer_cnt mt-5 mt-md-0 ps-xl-5 ms-xxl-5 ">
            <div class="right_cnt_onebox ">
              <h3 class="text-white font-18 fw-bold mb-4 text-uppercase text-center">
                <?= print_dynamic_variable('disclaimer_title_en') ?></h3>
          ...
          <div class="footer_link pt-3 pt-xxl-5">
            <ul class="footer_menus list-unstyled mb-0 d-flex justify-content-center">
              <li class="list-inline-item  me-4 mb-3  "><a href="https://lp.all-universe.com"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase">Home</a></li>
              <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase privacy_btn_open">Privacy
                  policy</a></li>
              <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase rules_btn_open">Ethical
                  rules</a></li>
              <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase gdpr_btn_open">GDPR</a></li>
              <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase cookie_btn_open">Cookie
                  policy</a></li>
              <li class="list-inline-item4 me-0 "><a href="javascript:void(0);"
                  class="text-black fw-bold text-decoration-none font-16 text-uppercase terms_btn_open">Terms of
                  service</a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="opensans fw-normal font16">
            ...
            1) Send your message to <a href="mailto:dpo@mg.all-universe.com" class="text-decoration-none">dpo@mg.all-universe.com</a><br><br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="opensans fw-normal font16">
            ...
            and all-universe is a trademark of Astroveo B.V. (“all-universe is a trademark of Astroveo B.V.”, “we”, “us”
