@php($asset_path = '/landers/landingpages/261912/')
            ...
            <div class="row justify-content-start">
                ...
                <div class="col-9 col-md-10 col-lg-10 my-auto">
                    <p class="font-18 text-white montserrat fw-regular text-center text-md-center">Dinheiro... Sorte...
                        Felicidade...</p>
                    <h2 class="font-40 montserrat fw-bold text-white text-center text-md-center">O que 2023 reserva para
                        voce?</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mx-0 w-100">
                <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
                        ...
                        <div class="row mx-0 w-100 justify-content-start">
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Áries</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Libra</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Peixes</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Gêmeos</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Escorpião</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    <img src="{{$srcImg}}sagittarius-icon.png"
                                         class="position-relative z-index-1 w-100">
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Sagitário</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Virgem</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Touro</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Capricórnio</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Câncer</span><br>
                            ...
                            <div class="col-3 col-md-3 col-lg-1 px-1 px-md-0">
                                <label class="choose_your_sign">
                                    ...
                                    <span
                                        class=" position-relative z-index-1 text-uppercase montserrat">Aquário</span><br>
                    ...
                    <div class="col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_2 d-none">
                        <div class="row">
                            ...
                            <div class="col-12 text-center text-md-start mt-5">
                                <button type="button"
                                        class="continue_btn font-16 text-white text-uppercase montserrat step_2_next">
                                    Continuar
                                </button>
                            </div>
                            <div class="col-6 pt-5 mt-3">
                                <p class="font-20 montserrat text-white fw-bold text-uppercase"><i
                    ...
                    <div class="col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_3 d-none">
                        <div class="row justify-content-start">
                            ...
                            <div class="col-12 text-center text-md-start mt-5">
                                <button type="button"
                                        class="continue_btn font-16 text-white text-uppercase montserrat step_3_next">
                                    Continuar
                                </button>
                            </div>
                            <div class="col-6 pt-5 mt-3">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                                <label class="montserrat font-20 text-white d-block fw-regular mb-2">Primeiro
                                    nome:</label>
                                <input type="text" placeholder="Primeiro nome" class="first_name_field"
                                       name="first_name">
                            </div>
                            ...
                            <div class="col-12 text-center text-md-start mt-5">
                                <button type="button"
                                        class="continue_btn font-16 text-white text-uppercase montserrat step_4_next">
                                    Continuar
                                </button>
                            </div>
                            <div class="col-6 pt-5 mt-3">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-12 col-md-12 col-lg-3 col-xl-8">
                                ...
                                <input type="text" placeholder="Por favor, introduza a sua cidade" name="city"
                                       class="first_name_field">
                            </div>
                            <span class="error step_5_error d-none">Por favor complete este campo</span>
                            <div class="col-12 text-center text-md-start mt-5">
                                <button type="button"
                                        class="continue_btn font-16 text-white text-uppercase montserrat step_5_next">
                                    Continuar
                                </button>
                            </div>
                            <div class="col-6 pt-5 mt-3">
                    ...
                    <div class="col-12 col-sm-12 col-md-10 col-xl-10 pt-3 step_6 d-none">
                        <div class="row justify-content-start">
                            <div class="col-12 col-md-12 col-lg-3 col-xl-8">
                            ...
                            <div class="col-12 text-center text-md-start mt-5">
                                <button type="submit"
                                        class="continue_btn font-16 text-white text-uppercase montserrat step_6_next"
                                        id="get_clarification">Obtenha meu horóscopo pessoal gratuito para 2022
                                </button>
                            </div>
                            <div class="col-6 pt-5 mt-3">
                                <p class="font-20 montserrat text-white fw-bold text-uppercase"><i
                                ...
                                <div class="col-12 col-sm-12 col-md-6">
                                    <div class="testimonial_content text-center text-md-start">
                                        ...
                                        <p class="text-646464 font-18 montserrat mt-4">Este guia realmente atendeu às
                                            minhas expectativas. Obrigado Ágata para oferecendo on-line.</p>
    ...
    <div class="container">
        <ul class="text-center list-inline list-unstyled mb-0">
            <li class="list-inline-item me-3"><a href="javascript:void(0);"
                                                 class="text-black montserrat fw-regular font-16 text-decoration-none privacy_modal">PRIVACIDADE
                    POLÍTICA</a>
            </li>
            <li class="list-inline-item me-3"><a href="javascript:void(0);"
                                                 class="text-black montserrat fw-regular font-16 text-decoration-none terms_modal">TERMOS
                    E CONDIÇÕES DA ASTROVEO</a></li>
            <li class="list-inline-item me-3"><a href="javascript:void(0);"
                                                 class="text-black montserrat fw-regular font-16 text-decoration-none gdpr_modal">GDPR</a>
            </li>
            <li class="list-inline-item"><a href="https://moon-pion.com/contact.php?lang=BR"
                                            class="text-black montserrat fw-regular font-16 text-decoration-none contact_modal text-uppercase">Contato</a>
            </li>
        </ul>
    </div>
</footer>
