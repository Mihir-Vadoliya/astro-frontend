@php($asset_path = '/landers/landingpages/190456/')
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TDDSKJP" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
                ...
                <div class="row">
                    ...
                    <div class="mid-main-box">
                        ...
                        <div class="gtm-screen-zodiac step__1 step_1">
                            <div class="step_1_head align-items-center">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_2_prev" onclick='back("1", "2")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_3_prev" onclick='back("2", "3")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                        ...
                        <div class="gtm-screen-city step__4 text-center custom_step_4 d-none" id='step_4'>
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <h6 class="font-36 color-e33afc">{{$texts->city_question}}</h6>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_4_prev" onclick='back("3", "4")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                        ...
                        <div class="gtm-screen-birthtimeknown step__5 text-center custom_step_5 d-none" id="step_5">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <h6 class="font-36 color-e33afc">{{$texts->time_question}}</h6>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="row justify-content-center py-50">
                                            ...
                                            <div class="control_btn">
                                                <div class="pre_btn step_5_prev" onclick='back("4", "5")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="gtm-screen-birthtime step__6 text-center custom_step_6 d-none" id="step_6">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <h6 class="font-36 color-e33afc">{{$texts->time}}</h6>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="row justify-content-center py-50">
                                            ...
                                            <div class="control_btn">
                                                <div class="pre_btn step_6_prev" onclick='back("5", "6")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row justify-content-center py-50">
                                            <div class="col-6  mb-10">
                                                <label class="choose_concerns_btn">
                                                    ...
                                                    <input type="radio" name="concerns" class="gtm-concern" data-gtm-value="work" value="Trabajo" checked>
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="col-6  mb-10">
                                                <label class="choose_concerns_btn">
                                                    ...
                                                    <input type="radio" name="concerns" class="gtm-concern" data-gtm-value="money" value="Finanzas">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="col-6 mb-10">
                                                <label class="choose_concerns_btn">
                                                    <span class=" position-relative z-index-1  montserrat  medium font24 text-white">{{$texts->just}}</span><br>
                                                    <input type="radio" name="concerns" class="gtm-concern" data-gtm-value="love" value="Amor">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="col-6  mb-10">
                                            ...
                                            <div class="control_btn">
                                                <div class="pre_btn step_7_prev" onclick='back("6", "7")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="row justify-content-center py-50">
                                            ...
                                            <div class="control_btn">
                                                <div class="pre_btn step_8_prev" onclick='back("7", "8")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="row justify-content-center py-50">
                                            ...
                                            <button class="btn_1 btn_1__scip step_9_btn" type="submit">{{$texts->submit}}</button>
                                            <div class="control_btn">
                                                <div class="pre_btn step_9_prev" onclick='back("8", "9")'><img alt="" src="{{ $asset_path }}assets/images/pre_btn.png"></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="gtm-screen-thankyou step__10 text-center custom_step_9 step_10 d-none" id="gtm-screen-thankyou">
    ...
    <div class="">
        <ul class="footer-links">
            <li><a class="text-uppercase" href="https://starsandthemoon-2020.com">{{$texts->home}}</a></li>
            <li><a href="#terms" class="cartonbox" data-cb-type="inline" data-cb-hash="text">{{$texts->terms}}</a></li>
            <li><a href="#privacy" class="cartonbox text-uppercase" data-cb-type="inline" data-cb-hash="text">{{$texts->privacy}}</a></li>
