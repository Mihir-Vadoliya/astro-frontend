@php($asset_path = '/landers/landingpages/600014/')
            ...
            <div class="modal-content border-1 rounded-5">
                <div class="modal-body">
                    <div class="modal-header">
                        <p class="modal-title font-20 fw-normal mb-0 text-center fw-bold">Volg me op sociale media voor meer
                            horoscopen en spirituele inhoud</p>
