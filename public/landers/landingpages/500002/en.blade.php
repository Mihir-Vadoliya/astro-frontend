@php($asset_path = '/landers/landingpages/500002/')
...
<body class="main_bg">
    ...
    <div class="astrology-offerpage-main  position-relative">
        ...
        <form name="g" id="nameForm" class="main_form" action="javascript:void(0);">
            ...
            <section class="gtm-screen-zodiac astrology-offerpage-step-1 step_1_content common_cls_display1" id="step_1">
                <div class="container">
                    <div class="box-content">
                        <p class="font-22 times pt-3 text-center fw-bold">What do you wish most for 2023? Money, Luck
                            or Love </p>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6 col-xxl-5">
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button type="button" class="all_continue_btn font-20 text-center text-white d-inline-block continue_btn-border">
                                        <b>CONTINUE</b></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="button" class="all_continue_btn font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border email_btn step_9_next">
            ...
            <section class="gtm-screen-thankyou last_step_content step_10 mt-2" id="step_11" style="display:none;">
    ...
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="contact_us1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">Terms and conditions</h5>
