...
$(".email_btn").click(function(){
    ...
    if (email == '') {
        ...
        var loader = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only sr-only px-3">Get your free reading </span>';
