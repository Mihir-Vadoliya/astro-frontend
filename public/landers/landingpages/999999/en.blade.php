...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;300;400;500;600;700;800;900&family=Josefin+Sans:wght@100;300;400;500;600;700&family=Josefin+Slab:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        ...
        <form name="g" id="nameForm" method="post" action="{{request()->url()}}/insertlead">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-3 col-md-3 col-lg-3 col-xl-2 col-xxl-2 my-auto">
                                <div class="per_image2 text-center">
                                    <a href="#" class="inner_logo1"><img src="{{$asset_path}}assets/images/astroveo-logo.png" class="img-fluid"></a>
                                </div>
                            </div>
                            <div class="col-3 col-md-3 col-lg-3 col-xl-2 col-xxl-2 my-auto text-end">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-end mb-0">
                                        <li class="breadcrumb-item"><a href="#" class="inter semi font22 text-white text-uppercase text-decoration-none">Home</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <section class="gtm-screen-zodiac choose_zodiac py-60 mt-100" id="step_1">
                <div class="container">
                            ...
                            <a href="javascript:void(0);" class="d-inline-block text-decoration-none select_your_sign">
                                <div class="select_sign">
                                    ...
                                    <div class="sign_dropdown_div">
                                        ...
                                        <img src="{{$asset_path}}assets/images/sign_selectorVector.png" class="img-fluid" alt="sign_selectorVector.png">
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-12 pt-50 text-center">
                        <ul class="list-unstyled list-inline">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_1_next">Continue</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="modal fade choose_sign_model" id="select_your_sign_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row justify-content-center" name="zodiac_sign">
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="aries">
                                                        ...
                                                        <span class="position-relative z-index-1 poetsenoneregular font20 color-824456">aries</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Mar
                                                            21 - Apr 20</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="taurus">
                                                        <img src="{{$srcImg}}taurus.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">taurus</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Apr
                                                            21 - May 20</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="gemini">
                                                        <img src="{{$srcImg}}gemini.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">gemini</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">May
                                                            21 - Jun 20</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="cancer">
                                                        <img src="{{$srcImg}}cancer.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">cancer</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Jun
                                                            21 - Jul 22</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="leo">
                                                        <img src="{{$srcImg}}leo.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">Leo</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Jul
                                                            23 - Aug 22</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="virgo">
                                                        ...
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">virgo</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Aug
                                                            23 - Sep 21</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="libra">
                                                        ...
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">libra</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Sep
                                                            22 - Oct 20</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="scorpio">
                                                        <img src="{{$srcImg}}scorpio.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">scorpio</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Oct
                                                            21 - Nov 20</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="sagittarius">
                                                        <img src="{{$srcImg}}sagittarius.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">sagittarius</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Nov
                                                            21 - Dec 21</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="capricorn">
                                                        <img src="{{$srcImg}}capricorn.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">capricorn</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Dec
                                                            22 - Jan 21</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="aquarius">
                                                        <img src="{{$srcImg}}aquarius.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">aquarius</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Jan
                                                            22 - Feb 18</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn your_sign" data-gtm-value="pisces">
                                                        <img src="{{$srcImg}}pisces.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">pisces</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Feb
                                                            19 - Mar 20</span>
                    ...
                    <div class="modal fade choose_sign_model" id="select_Partner_sign_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    ...
                                    <div class="row justify-content-center mx-0 w-100">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-9">
                                            <div class="row justify-content-center" name="zodiac_sign">
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn partner_sign" data-gtm-value="sagittarius">
                                                        <img src="{{$srcImg}}sagittarius.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">sagittarius</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Nov
                                                            21 - Dec 21</span>
                                                ...
                                                <div class="col-3 col-lg-3 px-20 mb-30">
                                                    <label class="choose_zodiac_btn partner_sign" data-gtm-value="capricorn">
                                                        <img src="{{$srcImg}}capricorn.png" class="position-relative z-index-1"><br>
                                                        <span class=" position-relative z-index-1 poetsenoneregular font20 color-824456">capricorn</span><br>
                                                        <span class="position-relative z-index-1  text-white josefin font16">Dec
                                                            22 - Jan 21</span>
                    ...
                    <div class="compatible_div">
                        <div class="row justify-content-center ">
                                ...
                                <div class=" text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item pe-xxl-3">
                                            <img src="{{$asset_path}}assets/images/OBJECT1.png" class="img-fluid" alt="OBJECT1.png" id="compatible_your_sign">
                                        ...
                                        <li class="list-inline-item ps-3 ps-xxl-5 ">
                                            <img src="{{$asset_path}}assets/images/OBJECT2.png" class="img-fluid" alt="OBJECT2.png" id="compatible_partner_sign">
                            ...
                            <div class="col-12 pt-50 text-center">
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0);" class="continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_11_next">Continue</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section class="gtm-screen-gender select_gender d-none" id="step_2">
                <div class="container">
                    <h3 class="text-center text-white font36 semi josefin mb-5 lh-70 text-capitalize">What is your<br><span class="fw-bold font56">Gender?</span></h3>
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6">
                            <div class="row justify-content-center">
                                <div class="col-5 col-md-5">
                                    <label class="choose_gender_btn">
                                        <img src="{{$asset_path}}assets/images/male-icon.png" class="img-fluid position-relative z-index-1">
                                ...
                                <div class="col-5 col-md-5">
                                    <label class="choose_gender_btn">
                                        <img src="{{$asset_path}}assets/images/female-icon.png" class="img-fluid position-relative z-index-1">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10">
                            <div class="row justify-content-center">
                                <div class="col-4">
                                    <select class="form-select born_input_field font24 semi inter text-white day" aria-label="Default select example " name="day">
                                ...
                                <div class="col-4">
                                    <select class="form-select born_input_field font24 semi inter text-white month" aria-label="Default select example " name="month">
                                ...
                                <div class="col-4">
                                    <select class="form-select born_input_field font24 semi inter text-white year" aria-label="Default select example " name="year">
                                ...
                                <div class="col-12 pt-50 text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="gtm-birthdate-continue continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_3_next">Continue</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6">
                            <div class="row justify-content-center">
                                <div class="col-12 text-center">
                                    <input type="text" placeholder="Please enter your city" name="city" class="born_input_field font24 semi inter text-center text-white">
                                ...
                                <div class="col-12 pt-50 text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_4_next">Continue</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="list-inline list-unstyled mb-0">
                                        <li class="list-inline-item">
                                            <label class="choose_yesno_btn">
                                                <span class=" position-relative z-index-1 text-uppercase inter text-white semi font24">Yes</span><br>
                                                <input class="gtm-birthtime" type="radio" name="bitth_time_know" value="yes" data-gtm-value="yes" checked>
                                                <span class="checkmark"></span>
                                            </label>
                                        </li>
                                        <li class="list-inline-item">
                                            <label class="choose_yesno_btn">
                                                <span class=" position-relative z-index-1 text-uppercase inter text-white semi font24">No</span><br>
                                                <input type="radio" class="gtm-birthtime" name="bitth_time_know" data-gtm-value="no" value="no">
                                                <span class="checkmark"></span>
                                            </label>
                                        </li>
                                    </ul>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6 col-xxl-6">
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <select class="form-select born_input_field font24 semi inter text-white hour text-center" aria-label="Default select example" name="tobhr">
                                ...
                                <div class="col-6">
                                    <select class="form-select born_input_field font24 semi inter text-white min text-center" aria-label="Default select example" name="tobmin">
                                        <option value="" selected="selected">Minute</option>
                                        @for ($i = 0; $i <= 60; $i+=5) <option value="{{$i}}">{{$i}}</option>
                                            @endfor
                                    </select>
                                </div>
                                ...
                                <div class="col-12 pt-50 text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_6_next">Continue</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <section class="gtm-screen-name select_gender d-none" id="step_8">
                <div class="container">
                    <h3 class="text-center text-white font36 semi josefin mb-5 lh-70 text-capitalize">What’s Your<br><span class="fw-bold font56">Name?</span>
                    </h3>
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6 col-xxl-6">
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <input type="text" placeholder="First name" name="first_name" class="born_input_field font24 medium inter text-white text-center">
                                </div>
                                <div class="col-6">
                                    <input type="text" placeholder="Last name" name="last_name" class="born_input_field font24 medium inter text-white text-center">
                                </div>
                                ...
                                <div class="col-12 pt-50 text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0);" class="continue_btn josefin medium text-decoration-none text-center d-inline-block text-white step_8_next">Continue</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <section class="gtm-screen-email select_gender d-none" id="step_9">
                <div class="container">
                    <h3 class="text-center text-white font36 semi josefin mb-4 mb-xl-4 mb-xxl-5 lh-70 text-capitalize">Where
                        Do You Want To Get Your comprehensive report for the compatibility of a<br><span class="fw-bold font56 text-capitalize"> <span class="signA">Sign A</span> and <span class="signB">Sign B</span>?</span>
                    </h3>
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6 col-xxl-5">
                            <form class="row justify-content-center">
                                <div class="col-12">
                                    <input type="email" placeholder="enter your e-mail" name="email" class="gtm-email born_input_field font24 semi inter text-white input-email text-center text-capitalize" required>
                        ...
                        <div class="col-12 col-md-8 col-xl-4 pt-50 text-center">
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
                                    <button type="submit" class="gtm-email-continue continue_btn josefin medium font20  text-decoration-none text-center d-inline-block w-100  px-5 text-white step_9_next">
            ...
            <section class="gtm-screen-thankyou select_gender " id="step_10">
                    ...
                    <div class="col-12 col-md-12 col-lg-12 my-auto  px-3 px-md-0">
                        <div class="footer_link pt-3 pt-xxl-5">
                            <ul class="footer_menus list-unstyled mb-0 d-flex justify-content-center">
                                <li class="list-inline-item  me-4 mb-3  "><a href="https://lp.all-universe.com" class="text-white fw-bold text-decoration-none font-16 text-uppercase josefin">Home</a>
                                </li>
                                <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase privacy_btn_open josefin">Privacy
                                        policy</a></li>
                                <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase rules_btn_open josefin">Ethical
                                        rules</a></li>
                                <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase gdpr_btn_open josefin">GDPR</a>
                                </li>
                                <li class="list-inline-item  me-4 mb-3 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase cookie_btn_open josefin">Cookie
                                        policy</a></li>
                                <li class="list-inline-item4 me-0 "><a href="javascript:void(0);" class="text-white fw-bold text-decoration-none font-16 text-uppercase terms_btn_open josefin">Terms
                                        of
                                        service</a></li>
                            </ul>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="josefin fw-normal font16">
                        ...
                        <a href="https://astro.all-universe.com" class="text-decoration-none">https://astro.all-universe.com</a> website (“Website” or “Service”)
