@php($asset_path = '/landers/landingpages/203811/')
@php($srcImg = "/landers/sets/set22/")
...
<body class="main_bg">
    ...
    <div class="astrology-offerpage-main  position-relative">
        ...
        <header class="astrology_offerpage_head header py-3 py-md-0 mt-md-2">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-12 col-md-7">
                        <div class="row">
                            <div class="col-12 text-center my-auto">
                                <a href="https://astro.astrology-prism.com/index.php?lang=DE"><img src="{{ $asset_path }}assets/images/astrology-offer-logo.png" class="img-fluid logo_image_responsive mb-0"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <form name="g" id="nameForm" class="row justify-content-center main_form" method="post" action="{{request()->url()}}/insertlead">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6 col-md-4 text-center">
                                    <label class="choose_gender_btn">
                                        ...
                                        <span class=" position-relative z-index-1 times text-white fw-bold text-uppercase font24">{{$texts->man}}</span><br>
                                ...
                                <div class="col-6 col-md-4">
                                    <label class="choose_gender_btn">
                                        ...
                                        <span class=" position-relative z-index-1 times text-white fw-bold text-uppercase font24">{{$texts->woman}}</span><br>
                                        <input type="radio" name="gender" value="F" >
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-12 text-center pt-4">
                                    <button type="button" class="all_continue_btn font-20 text-center text-black d-inline-block" onclick="back_step(1,2);">{{$texts->back}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6 col-xxl-5">
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button type="button" class="all_continue_btn font-20 text-center text-black d-inline-block">{{$texts->next}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6 col-xxl-5">
                            <div class="row justify-content-center mx-0 w-100">
                                <div class="col-12 col-xxl-10">
                                    <input type="text" name="city" placeholder="Bitte geben Sie Ihre Stadt ein" class="enter_city font24 medium times text-center text-blue">
                                </div>
                                <div class="col-12 ">
                                    <div class="text-center">
                                        <p class="text-white font-16 times pt-3">{{$texts->p_help}}</p>
                            ...
                            <ul class="list-inline list-unstyled text-center">
                                <li class="list-inline-item know-birth-time-yes">
                                    <label class="choose_yesno_btn">
                                        <span class=" position-relative z-index-1 text-uppercase times  medium font24 text-white">{{$texts->yes}}</span><br>
                                ...
                                <li class="list-inline-item know-birth-time-no">
                                    <label class="choose_yesno_btn">
                                        <span class=" position-relative z-index-1 text-uppercase times  medium font24 text-white">{{$texts->no}}</span><br>
                            ...
                            <div class="row justify-content-center py-50">
                                <div class="col-6 col-md-3  mb-10">
                                    <label class="choose_concerns_btn">
                                        <span class=" position-relative z-index-1  times  medium font24 text-white">{{$texts->work}}</span><br>
                                ...
                                <div class="col-6 col-md-3  mb-10">
                                    <label class="choose_concerns_btn">
                                        <span class=" position-relative z-index-1  times  medium font24 text-white">{{$texts->money}}</span><br>
                                ...
                                <div class="col-6 col-md-3 mb-10">
                                    <label class="choose_concerns_btn">
                                        <span class=" position-relative z-index-1  times  medium font24 text-white">{{$texts->love}}</span><br>
                                ...
                                <div class="col-6 col-md-3  mb-10">
                                    <label class="choose_concerns_btn">
                                        <span class=" position-relative z-index-1  times  medium font24 text-white">{{$texts->general}}</span><br>
                ...
                <div class="height-50"></div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6 col-xxl-6">
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <input type="text" placeholder="Bitte Vornamen eingeben" name="first_name" class="enter_name_det_field font24 medium times text-white">
                                </div>
                                <div class="col-6">
                                    <input type="text" placeholder="Nachnamen eingeben" name="last_name" class="enter_name_det_field font24 medium times text-white">
                                </div>
                                <span class="error2" style="display:none;">{{$texts->error_name}}</span>
                                <div class="col-12 text-center pt-4">
                                    <button type="button" class="all_continue_btn font-20 text-center text-black d-inline-block">{{$texts->next}}</button>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="submit" class="all_continue_btn step_9_continue font-20 text-uppercase text-center w-100 text-black d-inline-block">{{$texts->button_free}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="gtm-screen-thankyou d-none step_10 last_step_content" id="step_10">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="times fw-normal font-68 text-white text-center pt-5 pb-2"><?= print_dynamic_variable('disclaimer_title_de') ?>
                    </h2>
                ...
                <div id="footer">
                    <ul class="footer_menu text-center list-inline list-unstyled">
                        <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1  pe-xxl-1">
                            <a href="https://astro.astrology-prism.com/index.php?lang=DE" class="text-white text-uppercase text-decoration-none home_modal_open times font-20">{{$texts->home}}</a>
                        </li>
                        <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1  pe-xxl-1">
                            <a href="javascript:void(0);" class="text-white text-uppercase text-decoration-none tos_modal_open times font-20">Geschäftsbedingungen</a>
                        </li>
                        <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
                            <a href="javascript:void(0);" class="text-decoration-none text-uppercase cnt_pp_open  text-white times font-20">DATENSCHUTZRICHTLINIE</a>
                        </li>
                        <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
                            <a href="javascript:void(0);" class="text-decoration-none text-uppercase ethical_pp_open  text-white times font-20">ETHISCHE REGELN</a>
                        </li>
                        <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
                            <a href="javascript:void(0);" class="text-decoration-none text-uppercase gdpr_pp_open  text-white times font-20">GDPR</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="javascript:void(0);" class="text-white text-uppercase text-decoration-none cookie_pp_open times font-20"> COOKIE-RICHTLINIE</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="contact_us1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">Geschäftsbedingungen</h5>
    ...
    <div class="astrology-offerpage-hlp-pop modal fade contact_us_popup privacy-1" id="help_pp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">DATENSCHUTZRICHTLINIE</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
    ...
    <!-- GDPR  modal -->
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="gdpr" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
    ...
    <!-- ethical  modal -->
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="ethical_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel"> ETHISCHE REGELN</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
    ...
    <!-- cookie  modal -->
    <div class="astrology-offerpage-cntpopup modal fade contact_us_popup" id="cookie_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel"> COOKIE-RICHTLINIE</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
    ...
    <!-- FAQ modal -->
    <div class="astrology-offerpage-hlp-pop modal fade contact_us_popup" id="faq_pp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-0 border-0">
                <h5 class="modal-title text-center arial text-white fw-bold font-26" id="exampleModalLabel">FAQ</h5>
                <button type="button" class="btn-close p-0 rounded-0" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <p class="arial fw-light mb-4 text-black font-16 line-height-24 pt-3">
                        <b class="mt-2 d-block py-1">WAS IST DIE RICHTLINIE FÜR RÜCKERSTATTUNGEN?</b>
                        Wenn Sie mit dem gekauften Produkt/der gekauften Dienstleistung nicht zufrieden sind oder aus einem anderen Grund eine Rückerstattung wünschen, verwenden Sie die <a href="https://astro.astrology-prism.com/index.php?lang=DE#contact" class="text-decoration-none">contact</a> mit einer Bitte um Ihre Rückerstattung und wir werden diese entsprechend bearbeiten.
                        <br><br>
                        <b class="mt-2 d-block py-1">IN WELCHEM LAND SIND IHRE PRODUKTE/DIENSTLEISTUNGEN ERHÄLTLICH?</b>
                        Sie sind weltweit verfügbar, aber nur in bestimmten Sprachen. Derzeit sind sie in Englisch, Französisch, Deutsch und Niederländisch verfügbar.
                        <br><br>
                        <b class="mt-2 d-block py-1">WIE KANN ICH IHRE DIENSTE KÜNDIGEN?</b>
                        Bei unseren Produkten/Dienstleistungen handelt es sich nicht um eine Mitgliedschaft, daher besteht keine Notwendigkeit, sie zu kündigen. Es ist ein einmaliger Kauf. Wenn Sie sich jedoch von unserem Newsletter abmelden möchten, können Sie dies tun, indem Sie auf den Link am Ende jeder E-Mail klicken oder das Kontaktformular mit Ihrer E-Mail ausfüllen. Wir werden eine schnelle Überprüfung durchführen, um sicherzustellen, dass es sich wirklich um Ihre E-Mail-Adresse handelt.
                        <br><br>
                        <b class="mt-2 d-block py-1">WAS SIND DIE PREISE IHRER PRODUKTE/DIENSTLEISTUNGEN?</b>
                        Die Preise variieren je nach Produkt/Dienstleistung. Wir werden dies immer vorher mitteilen oder Sie können direkt im Geschäft nachsehen.
                        <br><br>
                        <b class="mt-2 d-block py-1">SIND DIE TESTIMONIALS VON ECHTEN MENSCHEN?</b>
                        Ja, sind Sie. Die Erfahrungen früherer Benutzer garantieren jedoch nicht, dass Sie die gleiche Erfahrung machen werden.
                        <br>
                    </p>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
           $('.ethical_pp_open').on('click',function(){
                $('#ethical_modal').modal('show');
           });
           $('.cookie_pp_open').on('click',function(){
                $('#cookie_modal').modal('show');
           });
           $('.step_9_continue').on('click', function(){
