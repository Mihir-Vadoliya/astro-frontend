@php($asset_path = '/landers/landingpages/285644/')
...
<body class="background my_new_bg main_bg">
    ...
    <form name="g" id="nameForm" class="main_form position-relative sign_show" method="post" action="{{request()->url()}}/insertlead">
                ...
                <div class="main_form">
                    <div class="row">
                        <div class="step__form">
                            ...
                            <div class="step__count">passo <span id="step__count">1</span> de 10</div>
                        </div>
                        ...
                        <div class="gtm-screen-zodiac step__1 step_1 card_div">
                            <div class="step_1_head d-flex align-items-center mb-0 mb-lg-2 w-700 mx-auto">
                                <h1 class="text-center">A sua leitura pessoal de tarot completamente livre</h1>
                            </div>
                            ...
                            <div id="main_section" class="">
                                <div class="row justify-content-center">
                                    <div class="col-xs-12 col-md-8 col-lg-6 mt15">
                                        <div class="row">
                                            <h3 class="ribbon">
                                                <strong id="header_pick_step" class="step-text ribbon-content elegante" data-content="Escolha 3 cartas"></strong>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center d-none">
                                    <button class="btn_1 btn_1__scip step_1_btn" type="button">Próxima pregunta &gt;&gt;
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="mid-main-box">
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-center py-50">
                                                <div class="col-12">
                                                    ...
                                                    <p class="date_text color-e33afc font-16">Isso irá ajudar a fazer a
                                                        leitura mais precisa.</p>
                                                </div>
                                            </div>
                            ...
                            <div class="gtm-screen-birthtime step__6 text-center custom_step_6 d-none" id="step_6">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12">
                                            <h6 class="font-36 color-e33afc">Por favor, introduza horas e minutos o mais
                                                exatos possível</h6>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-12">
                                            <div class="row justify-content-center py-50">
                                                ...
                                                <button class="btn_1 btn_1__scip step_9_btn" type="submit">Próxima pregunta
                                                    &gt;&gt;
                                                </button>
                                                <div class="control_btn">
                                ...
                                <div>
                                    <div>
                                        <h3 class="step_8__title text-center">
                                            Por favor, espere um momento, enquanto estou conectando você com seu<br />
                                            Guarda Angel...
                                        </h3>

                                        <div class="bg-text-new1">
                                            <p class="text-white font18 montserrat fw-normal text-md-start">
                                                P.S. Para que a sua confiança em mim seja merecida, quero que saiba que
                                                respeito o regulamento relativo à privacidade e ao acesso aos seus dados
                                                pessoais. Tudo está aqui, na minha
                                                <a href="#privacy" class="cartonbox text-white" data-cb-type="inline" data-cb-hash="text">Política de Privacidade</a>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="footer row mid-main-box">
            <div class="col-12">
                <h3 style="color: #e33afc" class="text-center font16"><?= print_dynamic_variable('disclaimer_title_pt') ?></h3>
        ...
        <div class="text-center">
            <ul class="footer-links list-inline">
                <li class="px-3 px-md-4 px-xxl-5 list-inline-item text-uppercase"><a href="https://starsandthemoon-2020.com">Home</a></li>
                <li class="px-3 px-md-4 px-xxl-5 list-inline-item"><a href="#terms" class="cartonbox" data-cb-type="inline" data-cb-hash="text">TERMOS E CONDIÇÕES</a></li>
                <li class="px-3 px-md-4 px-xxl-5 list-inline-item text-uppercase"><a href="#privacy" class="cartonbox" data-cb-type="inline" data-cb-hash="text">Política de
                        privacidade</a></li>
