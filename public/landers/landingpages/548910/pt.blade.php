@php($asset_path = '/landers/landingpages/548910/')
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TDDSKJP"
                ...
                <div class="mid-main-box">
                        ...
                        <div class="button-box bev" data-bevent="1" data-sign="aries">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="aries">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}aries.png" alt="aries"
                                                                     title="aries"></span>
                        ...
                        <div class="button-box bev" data-bevent="2" data-sign="taurus">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="taurus">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}taurus.png" alt="taurus"
                                                                     title="taurus"></span>
                        ...
                        <div class="button-box bev" data-bevent="3" data-sign="gemini">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="gemini">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}gemini.png" alt="gemini"
                                                                     title="gemini"></span>
                        ...
                        <div class="button-box bev" data-bevent="4" data-sign="cancer">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="cancer">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}cancer.png" alt="cancer"
                                                                     title="cancer"></span>
                        ...
                        <div class="button-box bev" data-bevent="5" data-sign="leo">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="leo">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}leo.png" alt="leo"
                                                                     title="leo"></span>
                        ...
                        <div class="button-box bev" data-bevent="6" data-sign="virgo">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="virgo">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}virgo.png" alt="virgo"
                                                                     title="virgo"></span>
                        ...
                        <div class="button-box bev" data-bevent="7" data-sign="libra">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="libra">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}libra.png" alt="libra"
                                                                     title="libra"></span>
                        ...
                        <div class="button-box bev" data-bevent="8" data-sign="scorpio">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="scorpio">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}scorpio.png" alt="scorpio"
                                                                     title="scorpio"></span>
                        ...
                        <div class="button-box bev" data-bevent="9" data-sign="sagittarius">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="sagittarius">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}sagittarius.png"
                        ...
                        <div class="button-box bev" data-bevent="10" data-sign="capricorn">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="capricorn">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}capricorn.png" alt="capricorn"
                        ...
                        <div class="button-box bev" data-bevent="11" data-sign="aquarius">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="aquarius">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}aquarius.png" alt="aquarius"
                                                                     title="aquarius"></span>
                        ...
                        <div class="button-box bev" data-bevent="12" data-sign="pisces">
                            <div class="sign-box">
                                <a href="#" class="gtm-zodiac" data-gtm-value="pisces">
                                    <span class="sign-box__img"><img src="{{ $srcImg }}pisces.png" alt="pisces"
                                                                     title="pisces"></span>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="row justify-content-center py-50">
                                        ...
                                        <div class="col-6 text-center">
                                            <label class="choose_gender_btn">
                                                <img src="{{ $asset_path }}assets/images/male.png"
                                                     class="position-relative z-index-1 me-1 me-lg-3">
                                                <span
                                                    class=" position-relative z-index-1 montserrat text-white  medium font24">Homem</span><br>
                                                <input type="radio" name="gender" class="gtm-gender" value="M"
                                                       data-gtm-value="male" checked>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-6">
                                            <label class="choose_gender_btn">
                                                <img src="{{ $asset_path }}assets/images/woman.png"
                                                     class="position-relative z-index-1 me-1 me-lg-3">
                                                <span
                                                    class=" position-relative z-index-1 montserrat text-white  medium font24">Mulher</span><br>
                                    ...
                                    <div class="control_btn">
                                        <div class="pre_btn step_2_prev" onclick='back("1", "2")'><img alt=""
                                                                                                       src="{{ $asset_path }}assets/images/pre_btn.png">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center py-50">
                                        <div class="col-12">
                                            ...
                                            <p class="date_text color-e33afc font-16">Isso irá ajudar a fazer a leitura
                                                mais precisa. </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control_btn">
                                        <div class="pre_btn step_3_prev" onclick='back("2", "3")'><img alt=""
                                                                                                       src="{{ $asset_path }}assets/images/pre_btn.png">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center py-50">
                                        <div class="col-12 text-center">
                                            <input type="text" placeholder="Por favor, introduza a sua cidade"
                                                   name="city"
                                                   class="city_filed font24 medium montserrat text-center text-black">
                                            <span class="error" id="step_4_error"></span>
                                        </div>
                                        <p class="date_text color-e33afc font-16">Isto irá ajudar a tornar a sua
                                            clarividência mais precisa.</p>
                                    </div>
                                    <button class="btn_1 btn_1__scip step_4_btn" type="button">Próxima pregunta >>
                                    </button>
                                    <div class="control_btn">
                                        <div class="pre_btn step_4_prev" onclick='back("3", "4")'><img alt=""
                                                                                                       src="{{ $asset_path }}assets/images/pre_btn.png">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="row justify-content-center py-50">
                                            ...
                                            <ul class="list-inline list-unstyled flex-columb">
                                                <li class="list-inline-item">
                                                    <label class="choose_yesno_btn">
                                                        <span
                                                            class=" position-relative z-index-1 text-uppercase montserrat  medium font24 text-white">Sim</span><br>
                                                        <input type="radio" name="yesno" value="1" class="gtm-birthtime"
                                                ...
                                                <li class="list-inline-item">
                                                    <label class="choose_yesno_btn">
                                                        <span
                                                            class=" position-relative z-index-1 text-uppercase montserrat  medium font24 text-white">Não</span><br>
                                                        <input type="radio" name="yesno" value="2" class="gtm-birthtime"
                                                               data-gtm-value="no">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </li>
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_5_prev" onclick='back("4", "5")'><img alt=""
                                                                                                           src="{{ $asset_path }}assets/images/pre_btn.png">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                    ...
                    <div class="gtm-screen-birthtime step__6 text-center custom_step_6 d-none" id="step_6">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="font-36 color-e33afc">Por favor, introduza horas e minutos o mais exatos
                                        possível</h6>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="row justify-content-center py-50">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_6_prev" onclick='back("5", "6")'><img alt=""
                                                                                                           src="{{ $asset_path }}assets/images/pre_btn.png">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    ...
                                    <div class="row justify-content-center py-50">
                                        <div class="col-6  mb-10">
                                            <label class="choose_concerns_btn">
                                                <span
                                                    class=" position-relative z-index-1  montserrat  medium font24 text-white">Trabalho</span><br>
                                                <input type="radio" class="gtm-concern" data-gtm-value="work"
                                                       name="concerns" value="1" checked>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-6  mb-10">
                                            <label class="choose_concerns_btn">
                                                ...
                                                <span
                                                    class=" position-relative z-index-1  montserrat  medium font24 text-white">Finanças</span><br>
                                                <input type="radio" class="gtm-concern" data-gtm-value="money"
                                                       name="concerns" value="2">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-6 mb-10">
                                            <label class="choose_concerns_btn">
                                                <span
                                                    class=" position-relative z-index-1  montserrat  medium font24 text-white">Amor</span><br>
                                                <input type="radio" class="gtm-concern" data-gtm-value="love"
                                                       name="concerns" value="3">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="col-6  mb-10">
                                            <label class="choose_concerns_btn">
                                                ...
                                                <span
                                                    class=" position-relative z-index-1  montserrat  medium font24 text-white">Geral</span><br>
                                                <input type="radio" class="gtm-concern" data-gtm-value="general"
                                                       name="concerns" value="4">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_7_prev" onclick='back("6", "7")'><img alt=""
                                                                                                           src="{{ $asset_path }}assets/images/pre_btn.png">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    ...
                                    <div class="row justify-content-center py-50">
                                        <div class="col-6">
                                            <input type="text" placeholder="Primeiro nome" name="first_name"
                                                   class="born_input_field font24 medium montserrat text-white">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_8_prev" onclick='back("7", "8")'><img alt=""
                                                                                                           src="{{ $asset_path }}assets/images/pre_btn.png">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                    ...
                    <div class="gtm-screen-email step__9 text-center custom_step_9 d-none" id="step_9">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="font-36 color-e33afc">Onde quer obter a sua clarividência
                                        personalizada?</h6>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                    ...
                                    <div class="row justify-content-center py-50">
                                        <div class="col-12 col-md-10">
                                            <input type="email" placeholder="E-mail" name="email"
                                                   class="gtm-email born_input_field font24 medium montserrat text-black input-email"
                                                   required="">
                                        ...
                                        <div class="control_btn">
                                            <div class="pre_btn step_9_prev" onclick='back("8", "9")'><img alt=""
                                                                                                           src="{{ $asset_path }}assets/images/pre_btn.png">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                    ...
                    <div class="row justify-content-center mx-0 w-100">
                        <div class="col-12 col-md-6 col-xxl-7">
                            <h3 class="times fw-normal font-68 text-center mb-4 pb-0 text-white">
                                Por favor, esperem um momento, enquanto eu vos ponho em contacto com o vosso anjo da
                                guarda...
                            </h3>
                        </div>
                    </div>
...
<div class="">
    <ul class="footer-links">
        ...
        <li><a href="#terms" class="cartonbox" data-cb-type="inline" data-cb-hash="text">TERMOS E CONDIÇÕES</a></li>
        <li><a href="#privacy" class="cartonbox text-uppercase" data-cb-type="inline" data-cb-hash="text">Política de privacidade</a>
        </li>
