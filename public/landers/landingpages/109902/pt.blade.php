@php($asset_path = '/landers/landingpages/109902/')
    ...
    <div class="mid-cirle">
        <div class="container">
            <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
                ...
                <input name="googleClientId" type="hidden" value="{{preg_replace("/^.+\.(.+?\..+?)$/", "\\1", @$_COOKIE['_ga'])}}">
                ...
                <div class="row">
                        ...
                        <div>
                            <div>
                                ...
                                <div class="bg-text-new1">
                                    <p class="text-white font18 montserrat fw-normal text-md-start">{{$texts->tip_text}}
                                        <a href="#privacy" class="cartonbox text-white" data-cb-type="inline" data-cb-hash="text">{{$texts->confidence}}</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="gtm-screen-thankyou step__10 text-center custom_step_9 step_10 d-none">
