@php($asset_path = '/landers/landingpages/231945/')
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="button" class="all_continue_btn font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border email_btn step_9_next"><i class="fa fa-hand-o-right px-2"></i><b>GET YOUR FREE READING</b></button>
                                </div>
                            </div>
                        </div>
                    </div>
