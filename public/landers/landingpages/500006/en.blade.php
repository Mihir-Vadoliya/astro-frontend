@php($asset_path = '/landers/landingpages/500006/')
...
<body class="main_bg">
    ...
    <div class="astrology-offerpage-main  position-relative">
        ...
        <div class="header-side">
            ...
            <h3 class="times font-100 text-center text-white px-right fw-bold pt-30"><span class="">Free Personal Horoscope 2023</span></h3>
            <!--<hr class="line">-->
        </div>
        ...
        <form name="g" id="nameForm" class="main_form" method="post" action="{{request()->url()}}/insertlead">
            ...
            <section class="gtm-screen-zodiac astrology-offerpage-step-1 step_1_content common_cls_display1 step_1" id="step_1">
                <div class="container">
                    <div class="box-content">
                        <p class="text-white font-16 times text-center fw-bold">What do you wish most for 2023? Money, Luck
                            or Love </p>
                    </div>
            ...
            <section class="gtm-screen-birthtime select_hour_minutes" id="step_6" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">Please enter the hours and minutes
            ...
            <section class="gtm-screen-email enter_email_field" id="step_9" style="display:none;">
                <div class="container">
                    <div class="height-50"></div>
                    <h3 class="times fw-normal font-68 text-white text-center mb-4 pb-0">Where do you want to receive your
                        ...
                        <div class="col-12 col-md-6 col-xxl-7">
                            <div class="row justify-content-center mx-0 w-100">
                                ...
                                <div class="col-12 col-lg-10 col-xxl-11 pt-4 text-center">
                                    <button type="submit" class="all_continue_btn font-20 text-uppercase text-center w-100 text-white d-inline-block continue_btn-border">
    ...
    <section class="gtm-screen-thankyou last_step_content" id="step_11" style="display:none;">
    ...
    <div class="mid-main-box times">
        ...
        <h2 style="color: white"><?= print_dynamic_variable('disclaimer_title_en') ?></h2>
        <p style="color: white">
        ...
        <div class=" container">
            <div id="footer">
                <ul class="footer_menu text-center list-inline list-unstyled">
                    ...
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1  pe-xxl-1">
                        <a href="javascript:void(0);" class="text-white text-uppercase text-decoration-none privacy_pp_open times font-20">PRIVACY POLICY</a>
                    </li>
                    <li class="list-inline-item me-0 me-md-3 me-xxl-5 pe-1 pe-xxl-1">
