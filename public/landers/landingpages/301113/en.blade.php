@php($asset_path = '/landers/landingpages/301113/')
@php($srcImg = "/landers/sets/set30/")
@php($facebook = "/landers/sets/set30/")
@php($pixel = "/landers/sets/set30/")
...
<body>
  ...
  <section class="main_banner">
    ...
    <div class="container" style="margin-top: 350px !important;">
      <div class="row">
