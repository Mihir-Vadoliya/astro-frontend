@php($asset_path = '/landers/landingpages/100835/')
                                ...
                                <div class="sign_sec">
                                    <div class="m_box m_box_group">
                                        ...
                                        <div class="text-center width100" id="relation-submit-btn">
                                            <button title="CONTINUE" type="button" class="gtm-birthdate-continue btn_1 bev continue" data-bevent="4">{{$texts->continue}}</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
